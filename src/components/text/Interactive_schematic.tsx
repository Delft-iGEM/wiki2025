...
export const InteractiveSchematic: React.FC = () => {
   return (
      <svg viewBox="0 0 1152.731 543.244" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <g className="step4" transform="translate(211.042 -67.862)">
    ...
    <image width="1" height="1" preserveAspectRatio="none" mask="url(#prefix__b)"
      ...
      <tspan x="311.098 315.153 317.053 321.108 322.896 329.225 335.53 337.317 339.281 343.837 348.047" y="395.834">0.4
        mM IPTG</tspan>
  ...
  <g className="step5" transform="translate(211.042 -67.862)">
  ...
  <g className="step6" transform="translate(211.042 -67.862)">
  ...
  <g className="step8" transform="translate(211.042 -67.862)">
  ...
  <g className="step9" transform="translate(211.042 -67.862)">
  ...
  <g className = "step10" transform="translate(211.042 -67.862)">
  ...
  <g className="step2" transform="translate(211.042 -67.862)">
    <path
  ...
  <g className="step7" transform="translate(211.042 -67.862)">
  ...
  <g className="step3" transform="translate(211.042 -67.862)">
