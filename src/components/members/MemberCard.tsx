  ...
  return (
    ...
    >
      <div className={`h-full w-full transition-transform duration-500 group-hover:-translate-y-3 ${isBackVisible ? "-translate-y-3" : ""}`}>
        ...
        >
          {/* Front side */}
          <div className={`absolute inset-0 flex h-full w-full flex-col items-center gap-3 rounded-2xl border border-border bg-white p-4 shadow-lg [backface-visibility:hidden]`}>
          ...
          {/* Back side */}
          <div className={`absolute inset-0 flex h-full w-full flex-col items-center gap-3 rounded-2xl border border-border bg-white p-6 text-center shadow-lg [backface-visibility:hidden] [transform:rotateY(180deg)]`}>
