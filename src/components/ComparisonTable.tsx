    ...
    <>
      ...
      <div className="hidden sm:block overflow-x-auto">
        ...
        <table className="comparison-table min-w-full">
          <thead>
            <tr className="header">
              <th className="toprowcell text-xs sm:text-sm md:text-xl font-bold text-left">
                advantages
              </th>
              <th className="toprowcell">traditional</th>
              <th className="toprowcell">mRNA</th>
              <th className="toprowcell text-xs sm:text-sm md:text-xl text-primary font-bold">
                snaccine
              </th>
            </tr>
          </thead>
          <tbody>
            {rowData.map((row) => (
              <tr key={row.advantage}>
                <td className="advantagecell">{row.advantage}</td>
                {row.entries.map((entry) => (
                  <td
                    key={`${row.advantage}-${entry.label}`}
                    className={`${entry.tableClass}`}
                  >
                    {entry.value}
                  </td>
                ))}
